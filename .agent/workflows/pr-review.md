...
2. **ドキュメント**
   ...
   - **注意**: `cosmo-linux/docs/` にドキュメントを置かないこと（`docs/cosmo-linux/` を使用）
3. **セキュリティ**
   - ローカルパス情報 (`/Users/`, `/home/`) が含まれていないこと
   - 確認: `grep -rn "/Users/" cosmo-linux/ .agent/ docs/ --include="*.md" --include="*.cm"`
4. **ビルド・テスト**
...
- 00N_ ドキュメント更新済み（`docs/cosmo-linux/` に配置）
